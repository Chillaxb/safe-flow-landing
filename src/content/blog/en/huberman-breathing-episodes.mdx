...
![6 episodes analyzed, scores from 2.8/5 to 4.6/5. Key finding: academic guests (Feldman, Spiegel, Epel) score highest for rigor, while commercial guests (Wim Hof, Mackenzie) have significant conflicts of interest to consider](/images/blog/huberman-podcast-setup.png)
...
## Episode #2: Jack Feldman — The Neuroscientist of Breathing
...
## Episode #3: Brian Mackenzie — The Performance Coach
...
## Episode #4: David Spiegel — The Stanford Cyclic Sighing Study
...
## Episode #6: Elissa Epel — Stress, Breathing & Cellular Aging
...
| Elissa Epel | UCSF Professor | ★★★★★ | Book sales | **4.6/5** |
